...
public final class CloseSessionAction  implements Action {
    ...
    private static final String DISPLAY_NAME = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayNameCloseSession");
    ...
    public String getDescription() {
        ...
        description.append("CloseSession Will Close the ssh connection to the remote Xterm Server.\n")
