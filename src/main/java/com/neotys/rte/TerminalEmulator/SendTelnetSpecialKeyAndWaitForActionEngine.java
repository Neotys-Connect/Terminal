 ...
 */
public class SendTelnetSpecialKeyAndWaitForActionEngine implements ActionEngine {
    String Host=null;
    String Check=null;
    String Key=null;
    ...
    private static SampleResult getErrorResult(final Context context, final SampleResult result, final String errorMessage, final Exception exception) {
        ...
        result.setStatusCode("NL-SendTelnetSpecialKeyAndWaitFor_ERROR");
